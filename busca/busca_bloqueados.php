...
if(!$data == ''){
    $empresa = $empresas = "SELECT * FROM empresa WHERE id_revenda = '$emp' AND bloqueado = 'S' AND razao LIKE '%$data%' OR cnpj LIKE '%$data%' ORDER BY codigo DESC";
} else {
    $empresa = $empresas = "SELECT * FROM empresa WHERE id_revenda = '$emp' AND bloqueado = 'S'";
}
